...
import handler from '../../../../pages/api/users/[telegramId]/admin-rooms';
...
app.get('/api/users/:telegramId/admin-rooms', (req, res) => {
    req.query.telegramId = req.params.telegramId;
    handler(req, res);
});

describe('GET /api/users/:telegramId/admin-rooms', () => {
  ...
  it('should return admin rooms', async () => {
    ...
    const res = await request(app).get('/api/users/123/admin-rooms');
